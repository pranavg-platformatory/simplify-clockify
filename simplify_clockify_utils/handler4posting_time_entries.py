...
class Handler4PostingTimeEntries(Handler4GettingSetupInfo):
    ...
    def _post_time_entry_to_workspace_id(self, workspace_id:str, time_entry:TimeEntry) -> Any:
        return self.post(f'workspaces/{workspace_id}/time-entries', time_entry.to_dict()).json()
    ...
    def post_time_entry_using_dict(self, time_entry_dict:dict) -> Any:
        ...
        return self._post_time_entry_to_workspace_id(self.workspace.id, time_entry)
    ...
    def post_time_entry_using_entries_yaml_object(self, data:list[dict]) -> list[Any]:
        ...
        for time_entry in time_entry_list:
            responses.append(self._post_time_entry_to_workspace_id(self.workspace.id, time_entry))
        return responses